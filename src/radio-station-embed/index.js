...
registerBlockType('terrificobjects/radio-station-embed', {
    title: 'Radio Station Embed',
    icon: 'calendar-alt',
    category: 'widgets',
    attributes: {
        align: {
    ...
    save: ({ attributes }) => {
        ...
        return <div {...blockProps} className="wp-block-terrificobjects-radio-station-embed"></div>;
    }
});
